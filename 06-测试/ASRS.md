---
title: ASRS
description: 成人 ADHD 自填筛查量表——基于 DSM-5-TR 标准的18题自评工具，由 Kessler et al. (2005) 开发，经 CFA 验证三因素结构，具有良好的信效度
aliases: [ASRS, Adult ADHD Self-Report Scale, 成人ADHD自填量表, ASRS v1.1]
tags: [test, adhd, neurodiversity]
sources: [Kessler et al. 2005, Kessler et al. 2007, Adler et al. 2006, Adler et al. 2018, Stanton et al. 2018, Hines et al. 2012, Alarachi et al. 2024]
created: 2026-05-11
updated: 2026-05-11
---
...
**ASRS**（Adult ADHD Self-Report Scale, v1.1）是一份18题自填问卷，用于评估成年人（18+）的[[ADHD]] 特征。量表基于 WHO 复合性国际诊断访谈（CIDI, 2001），题目与 DSM-IV 及 DSM-5-TR 标准一致，措辞专为反映成人的症状表现而设计（Kessler et al., 2005）。

> **本站测试**：[ASRS 成人 ADHD 自填量表](https://neuroxyz.cn/tests/asrs.html)

## 用途

ASRS 适用于成人 ADHD 的筛查和辅助诊断，应配合临床访谈使用以提供额外的临床信息。
...
Part A 包含对 ADHD 诊断最具预测力的 6 个条目（Kessler et al., 2007）。Part B 包含基于 DSM 标准的 12 个补充条目，提供更广泛的背景。评分方式已从二分法更新为 Likert 基方法，以增强临床效用和诊断精度（Harvard Medical School, 2024）。
