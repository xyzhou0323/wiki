...
[[病理学范式]]将孤独谱系定义为需要"治愈"的疾病。当一个家庭被告知孩子患有需要"治疗"的"障碍"时，求医行为本身是理性的——但这也打开了通往有害补充替代疗法的大门。
...
| 疗法 | 临床证据 | ND范式解读 |
|------|---------|-----------|
| **螯合治疗** | 无疗效证据；EDTA钠已致**低钙血症死亡**案例；螯合剂非特异性降低钙、铁、镁 | 前提（ASD=重金属中毒→需"清除"）是病理学范式极端形式；"清除体内毒素以修复ASD"的叙事仅在ASD被建构为病理实体时才成立 |
...
> 这一差异正是ND范式作为"干预评估透镜"（[[Neeman2021|Ne'eman, 2021]]）的独特价值：临床证据可以回答"这个疗法是否有效"，但无法回答"这个疗法的目标本身是否合乎伦理"。ND范式填补了这个伦理层面的评估空白。

## NICE (2021) 中的ND范式实践

[[NICE2021|NICE (2021)]] 是ND范式原则在主流临床政策中的部分渗透案例。虽然其底层框架仍根植于[[病理学范式]]（将孤独谱系定义为需要"诊断与管理"的"障碍"），但指南中的若干元素与ND取向兼容：
...
这套框架在排斥有害CAM的同时，完全兼容于解决自伤、促进沟通、缓解共现焦虑或抑郁等合法治疗目标。正是病理学范式——通过将"[[孤独谱系障碍|孤独谱系]]"本身建构为需根除的实体——模糊了有害CAM与合法支持之间的界限。
