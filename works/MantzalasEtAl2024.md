...
本文是**首篇系统检验[[孤独谱系倦怠]]测量工具心理测量特性的研究**，同时测试了两种工具：[AASPIRE](https://aaspire.org/) 社群参与式研究（CBPR）开发的未发表孤独谱系倦怠量表（ABM，27 题），以及已在职业倦怠研究中广泛使用的哥本哈根倦怠量表（CBI）的个人和工作子量表。研究首次报告了孤独谱系倦怠的流行率估计。
